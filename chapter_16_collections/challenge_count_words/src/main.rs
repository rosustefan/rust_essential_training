...
fn main() {
    // read file and return an error if its NOK
    ...
    // build vector of individual words: iterator collected into a vector of string slices
    ...
    // display results
    println!("Top word(s) occured {} times:", top_count);
